...
# UserManager — логика управления пользователем
...
# Зависимости, которые используются в эндпоинтах
# current_user — возвращает авторизованного пользователя
# current_superuser — возвращает только суперюзера
